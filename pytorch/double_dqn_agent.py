...
class Agent():
    ...
    def replay(self):
        ...
        nextstate_action_index = self.qnetwork(next_states).max(dim=1)[1].unsqueeze(1)
        targetnetwork_outputs = self.tragetnetwork(next_states).gather(1, nextstate_action_index)
